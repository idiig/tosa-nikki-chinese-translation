...
#+end_quote
#+begin_src shell
  git clone --recurse-submodules https://github.com/idiig/tosa-nikki-chinese-translation.git # clone the repo
  cd tosa-nikki-chinese-translation # enter the repo
  make update			  # update the submodule and extract the raw translation
  make glossary			  # generate glossary.json
  # Manually edit ./build/glossary.json to ./data/glossary.edited.json
  make stage			# stage the edited glossary
  make activate			# activate the edited glossary
  make fill			# fill the glossary abbreviations in the main text
  make publish			# publish the auto-generated results
  make publish-edited		# publish the edited glossary
#+end_src
** 克隆
#+begin_src shell
